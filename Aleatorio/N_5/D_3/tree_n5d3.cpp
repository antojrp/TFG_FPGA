...
void tree_n5d3(float inr_1[2], float ini_1[2],float inr_2[2], float ini_2[2], float inr_3[2], float ini_3[2],float inr_4[2], float ini_4[2],
        ...
        float mr_19[4][4], float mi_19[4][4], float mr_20[4][4], float mi_20[4][4],float mr_21[4][4], float mi_21[4][4], float mr_22[4][4], float mi_22[4][4],float mr_23[4][4], float mi_23[4][4], float mr_24[4][4], float mi_24[4][4],float mr_25[4][4], float mi_25[4][4], float mr_26[4][4], float mi_26[4][4],
        float mr_27[4][4], float mi_27[4][4], float mr_28[4][4], float mi_28[4][4],float mr_29[4][4], float mi_29[4][4], float mr_30[4][4], float mi_30[4][4],float mr_31[4][4], float mi_31[4][4], float mr_32[4][4], float mi_32[4][4],float mr_33[4][4], float mi_33[4][4], float mr_34[4][4], float mi_34[4][4])
...
#pragma HLS INTERFACE mode=s_axilite port=mi_34
  ...
  for(int i = 0; i < 4; i++) {
            ...
            mixi18[i]= 0;
            for(int k = 0; k < 4; k++) {
              mrxr18[i] += mr_10[i][k] * auxr_18[k];
              mrxi18[i] += mr_10[i][k] * auxi_18[k];
              mixr18[i] += mi_10[i][k] * auxr_18[k];
              mixi18[i] += mi_10[i][k] * auxi_18[k];
            }
          }
  ...
  for(int i = 0; i < 4; i++){
    	  outr[2*i]=mrxr27[i]-mixi27[i];
    	  outi[2*i]=mrxi27[i]+mixr27[i];
    	  outr[2*i+1]=mrxr28[i]-mixi28[i];
    	  outi[2*i+1]=mrxi28[i]+mixr28[i];

    	  outr[2*i+8]=mrxr29[i]-mixi29[i];
    	  outi[2*i+8]=mrxi29[i]+mixr29[i];
    	  outr[2*i+9]=mrxr30[i]-mixi30[i];
    	  outi[2*i+9]=mrxi30[i]+mixr30[i];

    	  outr[2*i+16]=mrxr31[i]-mixi31[i];
    	  outi[2*i+16]=mrxi31[i]+mixr31[i];
    	  outr[2*i+17]=mrxr32[i]-mixi32[i];
    	  outi[2*i+17]=mrxi32[i]+mixr32[i];

    	  outr[2*i+24]=mrxr33[i]-mixi33[i];
    	  outi[2*i+24]=mrxi33[i]+mixr33[i];
    	  outr[2*i+25]=mrxr34[i]-mixi34[i];
    	  outi[2*i+25]=mrxi34[i]+mixr34[i];
