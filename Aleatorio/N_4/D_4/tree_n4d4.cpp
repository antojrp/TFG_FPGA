...
void tree_n4d4(float inr_1[2], float ini_1[2],float inr_2[2], float ini_2[2], float inr_3[2], float ini_3[2],float inr_4[2], float ini_4[2],
...
float mr_15[4][4], float mi_15[4][4], float mr_16[4][4], float mi_16[4][4], float mr_17[4][4], float mi_17[4][4], float mr_18[4][4], float mi_18[4][4])
{
...
#pragma HLS INTERFACE mode=s_axilite port=mi_18
  ...
  auxr_15[0]=mrxr11[0]-mixi11[0];
  auxi_15[0]=mixr11[0]+mrxi11[0];
  auxr_15[1]=mrxr11[2]-mixi11[2];
  auxi_15[1]=mixr11[2]+mrxi11[2];
  auxr_15[2]=mrxr12[0]-mixi12[0];
  auxi_15[2]=mixr12[0]+mrxi12[0];
  auxr_15[3]=mrxr12[2]-mixi12[2];
  auxi_15[3]=mixr12[2]+mrxi12[2];

  auxr_16[0]=mrxr11[1]-mixi11[1];
  auxi_16[0]=mixr11[1]+mrxi11[1];
  auxr_16[1]=mrxr11[3]-mixi11[3];
  auxi_16[1]=mixr11[3]+mrxi11[3];
  auxr_16[2]=mrxr12[1]-mixi12[1];
  auxi_16[2]=mixr12[1]+mrxi12[1];
  auxr_16[3]=mrxr12[3]-mixi12[3];
  auxi_16[3]=mixr12[3]+mrxi12[3];

  auxr_17[0]=mrxr13[0]-mixi13[0];
  auxi_17[0]=mixr13[0]+mrxi13[0];
  auxr_17[1]=mrxr13[2]-mixi13[2];
  auxi_17[1]=mixr13[2]+mrxi13[2];
  auxr_17[2]=mrxr14[0]-mixi14[0];
  auxi_17[2]=mixr14[0]+mrxi14[0];
  auxr_17[3]=mrxr14[2]-mixi14[2];
  auxi_17[3]=mixr14[2]+mrxi14[2];

  auxr_18[0]=mrxr13[1]-mixi13[1];
  auxi_18[0]=mixr13[1]+mrxi13[1];
  auxr_18[1]=mrxr13[3]-mixi13[3];
  auxi_18[1]=mixr13[3]+mrxi13[3];
  auxr_18[2]=mrxr14[1]-mixi14[1];
  auxi_18[2]=mixr14[1]+mrxi14[1];
  auxr_18[3]=mrxr14[3]-mixi14[3];
  auxi_18[3]=mixr14[3]+mrxi14[3];
...
for(int i = 0; i<4; i++) {
    	  outr[2*i]=mrxr15[i]-mixi15[i];
    	  outi[2*i]=mixr15[i]+mrxi15[i];
    	  outr[2*i+1]=mrxr16[i]-mixi16[i];
    	  outi[2*i+1]=mixr16[i]+mrxi16[i];

    	  outr[2*i+8]=mrxr17[i]-mixi17[i];
    	  outi[2*i+8]=mixr17[i]+mrxi17[i];
    	  outr[2*i+9]=mrxr18[i]-mixi18[i];
    	  outi[2*i+9]=mixr18[i]+mrxi18[i];
          }
